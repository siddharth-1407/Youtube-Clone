...
const CategorySports = () => {
	...
	let query = '&videoCategoryId=17';
	useEffect(() => {
		setSelectCategory('Sports');
		ResetMetaTags();
	...
	const ResetMetaTags = () => {
		document.title = 'Sports - YouTube Clone';
	...
	return (
		<div className='flex min-h-[calc(100vh-56px)] h-full'>
			...
			{!loading && (
				<div
					className={`main-feed | ml-0 flex flex-wrap justify-center gap-y-7 gap-x-2 p-0 sm:py-5 mx-auto overflow-auto text-white ${
